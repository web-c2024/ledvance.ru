...
$MESS["SEARCH_CORRECT_AND_CONTINUE"] = "<p><strong>Пустой поисковый запрос.</strong> Исправьте поисковую фразу и повторите поиск.</p>";
...
$MESS["SEARCH_SINTAX"] = "<h5>Синтаксис поискового запроса:</h5><ul><li>Обычно запрос представляет из себя просто одно или несколько слов, например: <i>контактная информация</i>. По такому запросу будут найдены страницы, на которых встречаются оба слова запроса.<li>Логические операторы позволяют строить более сложные запросы, например: <i>контактная информация или телефон</i>. По такому запросу будут найдены страницы, на которых встречаются либо слова <i>контактная</i> и <i>информация</i>, либо слово <i>телефон</i>, <i>контактная информация не телефон</i> &mdash; по такому запросу будут найдены страницы, на которых встречаются либо слова <i>контактная</i> и <i>информация</i>, но не встречается слово <i>телефон</i>.<li>Вы можете использовать скобки для построения более сложных запросов.</li></ul>";
