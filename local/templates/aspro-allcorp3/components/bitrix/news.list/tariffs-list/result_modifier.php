...
if ($arParams['TABS'] === 'TOP') {
	// get all top tabs
	$arResult['TABS'] = TariffItem::collectTabs($arParams['IBLOCK_ID'], $arParams['FILTER_NAME']);
...
$arParams['DEFAULT_ITEM_NAME'] = TariffItem::translit($arParams['DEFAULT_ITEM_NAME'] ?: '');
			...
			if(
				...
				elseif ($key2 === 'TARIF_ITEM') {
					foreach ($arProp['VALUE'] as $i => $value) {
						...
						$price_key = TariffItem::translit($itemTitle);
