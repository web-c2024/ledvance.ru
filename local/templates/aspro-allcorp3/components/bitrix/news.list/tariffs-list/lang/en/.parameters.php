...
$MESS["T_SHOW_DETAIL_LINK"] = "Display link to detail page";
$MESS["T_SHOW_PREVIEW_TEXT"] = "Display text under heading";
$MESS["T_SHOW_SECTION"] = "Show section on items";
$MESS["T_SUBTITLE"] = "Additional heading above the main block heading";
$MESS["T_TITLE"] = "Block header";
$MESS["T_VISIBLE_PROP_COUNT"] = "Number of displayed characteristics";
