...
<?if($arResult["ALLOW_ANONYMOUS"]=="Y" && $_REQUEST["authorize"]<>"YES" && $_REQUEST["register"]<>"YES"):?>
	<div class="authorization-block top-form">
		...
		<div><?echo GetMessage("adm_auth1")?> <a href="<?=SITE_DIR?>cabinet/?backurl=<?=SITE_DIR;?>personal/subscribe/<?/*echo $arResult["FORM_ACTION"]?>?authorize=YES&amp;sf_EMAIL=<?echo $arResult["REQUEST"]["EMAIL"]?><?echo $arResult["REQUEST"]["RUBRICS_PARAM"]*/?>"><?echo GetMessage("adm_auth2")?></a>.</div>
		<?if($arResult["ALLOW_REGISTER"]=="Y"):?>
			<div><?echo GetMessage("adm_reg1")?> <a href="<?=SITE_DIR?>cabinet/registration/?backurl=<?=SITE_DIR;?>personal/subscribe/<?/*echo $arResult["FORM_ACTION"]?>?register=YES&amp;sf_EMAIL=<?echo $arResult["REQUEST"]["EMAIL"]?><?echo $arResult["REQUEST"]["RUBRICS_PARAM"]*/?>"><?echo GetMessage("adm_reg2")?></a>.</div>
		<?endif;?>
	</div>
