	...
	<div class="module-form-block-wr">
		<div class="form-block form">
			<form method="post" action="<?=$arParams["URL"];?>">
				<div class="form-group fill-animate input-filed bg-color">
	                <label for="EMAIL_CONFIRM" class="font_13 color_999"><?echo GetMessage("CT_BSAC_LOGIN")?></label>
	                <div class="input">						
	            ...
	            <div class="form-group fill-animate bg-color">
	                <label for="CONFIRM_CODE" class="font_13 color_999"><?echo GetMessage("CT_BSAC_CONFIRM_CODE")?></label>
	                <div class="input">
				 ...
				 <div class="but"><input type="submit" class="btn btn-default btn-lg bold" value="<?echo GetMessage("CT_BSAC_CONFIRM")?>" /></div>
