        ...
        <?if($bTab):?>
            ...
            <?else:?>
                <div class="tab-pane <?=(!($iTab++) ? 'active' : '')?>" id="staff">
                    <div class="ordered-block__title switcher-title font_22"><?=(strlen($arParams["T_STAFF"]) ? $arParams["T_STAFF"] : (count($templateData['STAFF']['VALUE']) > 1 ? GetMessage('T_STAFF2') : GetMessage('T_STAFF1')))?></div>
                    <?=$html_staff?>
                </div>
            <?endif;?>
        <?else:?>
